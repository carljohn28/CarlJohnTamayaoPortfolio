"use strict";
var _cc=function(){function t(t,i){for(var s=0;s<i.length;s++){var e=i[s];e.enumerable=e.enumerable||!1,e.configurable=!0,"value"in e&&(e.writable=!0),Object.defineProperty(t,e.key,e)}}return function(i,s,e){return s&&t(i.prototype,s),e&&t(i,e),i}}();
function _ccc(t,i){if(!(t instanceof i))throw new TypeError("Cannot call a class as a function")}
...
var e=function(){
  ...
  return _cc(t,[{
    ...
    value:function(t){
      var i=this.srpiq();
      return 3===t?(this.x=i.x+i.halfWidth,this.y=i.y)
      :2===t?(this.x=i.x,this.y=i.y+i.halfHeight)
      :1===t?(this.x=i.x+i.halfWidth,this.y=i.y+i.halfHeight)
    ...
    key:"grd",
    value:function(){return Math.random()>.5?1:-1}
  },{
    key:"grs",
    value:function(){
...
var h=function(){
  function h(i){
    ...
    this.el=i.element || document.querySelector(".finisher-header");
    if(!this.el) throw new Error("FinisherHeader: element not found");

    this.c=document.createElement("canvas");
    this.x=this.c.getContext("2d");
    this.c.setAttribute("class","finisher-canvas");
  ...
  return _cc(h,[{
    key:"resize",
    value:function(){
      this.o.c={w:this.el.clientWidth,h:this.el.clientHeight};
