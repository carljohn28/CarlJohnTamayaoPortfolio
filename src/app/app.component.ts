          ...
          columns: [
            {
              ...
              stack: [
                ...
                { text: 'CARL JOHN Q. TAMAYAO', fontSize: 16, bold: true, color: 'white' },
                { text: 'WEB DEVELOPER', color: 'white' },

                { text: 'C O N T A C T', color: 'white', alignment: 'center', margin: [0, 20, 0, 10] },
                { text: '(+63) 997 664 9549', color: 'white', },
                { text: 'carljohntamayao@gmail.com', color: 'white', },
                { text: 'Atulayan Norte, Tug. City', color: 'white', },
